...
/**
 * Funktionalitet til at opbygge SQL statements
 */
public class DBWrapper {
    ...
    /**
     * Metoden bruges til at bygge første del af et SQL-statement op.
     * Er der ingen specifikke attributter der ønskes returneret, returneres alle.
     * Ellers bygger den attributterne ind i SQL-Statementet og returnerer dette.
    ...
    /**
     * Metoden bruges til at bygge anden del af et SQL-statement op.
    ...
    /**
     * Metoden bruges til at bygge tredje del af et SQL-statement op.
     * Skal der ikke specificeres en WHERE clause, springes denne over.
    ...
    private static String buildWhere(Map<String, String> params, String sql){
        ...
        if(!params.isEmpty()){
            ...
            while(iterator.hasNext())
            {
                ...
                // Er der flere entries i params klargøres til næste entry
    ...
    /**
     * Metoden bruges til at bygge en VALUES clause.
     * @param values Et Map<K,V> der indeholder et selvvalgt antal set 'Keys' med specificeret 'Values' - "INSERT INTO (key) VALUES ("value")".
    ...
    /**
     * Metoden anvendes til at opbygge et UPDATE SQL statement
     * @param table den tabel der ønskes opdateret
     * @param fields de felter der ønskes opdateret
     * @param whereStmts det ønskede filter
     * @throws SQLException
     */
    ...
    /**
     * Metoden anvendes til at opbygge et UPDATE SQL statement
     * @param sql begyndelsen på det ønskede statement
     * @param fields de felter der ønskes opdateret
     * @return Et UPDATE SQL Statement
     */
    ...
    /**
     * Metoden anvendes til at opbygge et DELETE SQL statement
     * @param table den ønskede tabel
     * @param whereStmts det ønskede filter
     * @throws SQLException
     */
